...
<body>
    ...
    <section id="home_banner" class="">
        <div class="banner_container text-light text-center">
            <h1 class="text-uppercase">Hand picked book <br> to your door</h1>
            <p class="my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis consequatur repellendus iure. Nihil eum sit architecto. Sed, dolores necessitatibus. Similique?</p>
            <a href="shop.php" class="btn btn-lg btn-primary rounded-0">Discover more</a>
        </div>
    </section>
    <!------------------ end banner --------------------------->
    ...
    <section class="py-5 bg-light">
        <div class="container-lg">
            <h1 class="text-center text-uppercase text-danger mb-5">Latest Products</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div class="bg-light p-3">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae pariatur, doloremque vero recusandae culpa blanditiis dicta ipsa iure reiciendis odit.</p>
                        <a href="about.php" class="btn btn-lg btn-primary">Read more</a>
                    </div>
                </div>
    ...
    <!------------------------- start banner3 ------------------------->
    <section class="py-3 bg-secondary text-white">
        <div class="row">
            <div class="col-md-7 text-center mx-auto">
                <h2 class="mb-3">Have any Question</h2>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae, voluptatibus. Itaque, quam numquam quis adipisci fuga magni eum? Quo amet maxime nesciunt deleniti asperiores! Excepturi exercitationem consequuntur ea commodi atque.
                </p>
